...
#$ -wd /home/tcrnerc/Scratch/models/allee/temp
...
# 10. Run the script. 
Rscript  /home/tcrnerc/Scratch/models/allee/submitNGC2Complete.R $SGE_TASK_ID
# 11. Move the file
mv *.csv $HOME/Scratch/output/allee/overlapNGC
