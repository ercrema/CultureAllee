...
%Check if $R_{max}=\frac{r(A-K)^2}{4AK}$ this actually true, or is rather $R_{max}=\frac{r(K-A)2}{4AK}$
...
%This should be changed with the basin plot and the time-series; omit discussion on bifurcation
