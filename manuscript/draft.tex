...
\end{figure*}
%Is it possible to change this figure to the settings for lambda=0.75 in figure5.pdf, setting as z 0 and 0.2? This way we get a much stronger changes in the basin of attraction, and we could also mention here point 6 above?
...
% I think we should use different parameter combinations for this second plot. Basically we have lambda=0.95 and lambda=0.9 being identical, and lambda=0.6~0.5 also identical. Ideally we should also think about slightly more refined interval for z as well?
