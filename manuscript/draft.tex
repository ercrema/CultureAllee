...
%Describe here the basic model and the stability nodes
%time series and basin of attractions
\subsection{Effect of social learning $z>0$}
%Stability nodes remain unchanged for low z, high z determines unstable equilibria
%illustrate examples with different settings
%overlap analysis and changes in basin size
